...
public class DateUtils {
    ...
    public String dateFormatStart(long time) {
        String format = new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault())
                .format(new Date(time));
        format=format+"T00:00:00+08:00";
        return format;
    }
    public String dateFormatEnd(long time) {
        String format = new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault())
                .format(new Date(time));
        format=format+"T23:59:59+08:00";
        return format;
    }
    ...
    public Date transitionTime(String time){
    ...
    /**
     * 时间判断
     * @param startDateInput 开始时间
     * @param endDateInput
     * @param startDate  对比的开始时间
     * @param endDate
     * @return
     */
    public boolean timeComparison(Date startDateInput,Date endDateInput,Date startDate,Date endDate){
